...
{
	class UmaMusumeEyesEffect
		: public EffectBase
	{
	public:
		UmaMusumeEyesEffect(std::shared_ptr<DXDevice> device, string m_FilePath);
		virtual ~UmaMusumeEyesEffect();
	...
	private:
		...
		ComPtr<ID3DX11EffectShaderResourceVariable> m_EyesHighlight00Map;
		ComPtr<ID3DX11EffectShaderResourceVariable> m_EyesHighlight01Map;
		ComPtr<ID3DX11EffectShaderResourceVariable> m_EyesHighlight02Map;
