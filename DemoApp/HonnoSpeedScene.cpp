...
HonnoSpeedScene::HonnoSpeedScene()
	: SceneBase("HonnoSpeedScene")
{
...
void HonnoSpeedScene::BuildScene()
{
	// 메인 카메라 셋팅
	...
	// 리소스 로드
	// UmaMusume Stage
	ResourceManager::GetInstance()->LoadResource_ASEFile("Resource/ASEFile/pfb_env_live10108.ase");
	...
	// UmaMusume Assemble
	// Stage
	m_Stage = CreateGameObjectFromPrefab("Resource/ASEFile/pfb_env_live10108.ase");
...
void HonnoSpeedScene::InputCharID()
{
	std::cout << std::endl;
...
bool HonnoSpeedScene::CheckCharID(std::string charID)
{
	if (charID == "1002"
		|| charID == "1003"
		|| charID == "1004"
...
void HonnoSpeedScene::Release()
{
	SceneBase::Release();
}

void HonnoSpeedScene::LateUpdate(float deltaTime)
{
