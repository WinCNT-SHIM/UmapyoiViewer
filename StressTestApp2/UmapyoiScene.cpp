...
UmapyoiScene::UmapyoiScene()
	: SceneBase("UmapyoiScene")
{
...
bool UmapyoiScene::CheckCharID(std::string charID)
{
	if (charID == "1002"
		|| charID == "1003"
		|| charID == "1004"
...
void UmapyoiScene::Release()
{
	SceneBase::Release();
}

void UmapyoiScene::LateUpdate(float deltaTime)
{
